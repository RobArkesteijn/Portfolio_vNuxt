  ...
  messages: {
    en: {
      ...
      skills: {
        ...
        css: 'Visit the CSS Official Website',
        firebase: 'Visit the Firebase Official Website',
        html: 'Visit the HTML Official Website',
        javascript: 'Visit the Javascript Official Website',
        jquery: 'Visit the JQuery Official Website',
        mui: 'Visit the MUI Official Website',
        next: 'Visit the Next Official Website',
        nodejs: 'Visit the NodeJs Official Website',
        nuxt: 'Visit the Nuxt Official Website',
        pinia: 'Visit the Pinia Official Website',
        react: 'Visit the React Official Website',
        sass: 'Visit the Sass Official Website',
        tailwind: 'Visit the Tailwind Official Website',
        typescript: 'Visit the Typescript Official Website',
        vue: 'Visit the Vue.js Official Website',
      },
      projects: {
        title: 'Projects',
    ...
    nl: {
      ...
      skills: {
        ...
        css: 'Bezoek de CSS Officiële Website',
        firebase: 'Bezoek de Firebase Officiële Website',
        html: 'Bezoek de HTML Officiële Website',
        javascript: 'Bezoek de Javascript Officiële Website',
        jquery: 'Bezoek de JQuery Officiële Website',
        mui: 'Bezoek de MUI Officiële Website',
        next: 'Bezoek de Next Officiële Website',
        nodejs: 'Bezoek de NodeJs Officiële Website',
        nuxt: 'Bezoek de Nuxt Officiële Website',
        pinia: 'Bezoek de Pinia Officiële Website',
        react: 'Bezoek de React Officiële Website',
        sass: 'Bezoek de Sass Officiële Website',
        tailwind: 'Bezoek de Tailwind Officiële Website',
        typescript: 'Bezoek de Typescript Officiële Website',
        vue: 'Bezoek de Vue.js Officiële Website',
      },
      projects: {
        title: 'Projecten',
